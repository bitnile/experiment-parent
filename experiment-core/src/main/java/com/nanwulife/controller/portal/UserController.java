...
public class UserController {
    ...
    @ResponseBody
    public ServerResponse<User> register(Long username, String password, String passwordCheck, Integer majorId,
                                         Integer stuClass, String stuName, HttpSession session){
